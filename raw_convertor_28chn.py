...
Last modified: 3/25/2025 12:36:15 PM
"""
        ...
        for onepkg_index in pkg_index:
            ...
            while i < len(onepkgdata) :
                if (onepkgdata[i] == 0xface ) or (onepkgdata[i] == 0xfeed ):
                    ...
                    chn_data[16+7].append( ((onepkgdata[i+1+12] & 0X0FFF)<<0 ))
                    chn_data[16+6].append( ((onepkgdata[i+2+12] & 0X00FF)<<4)+ ((onepkgdata[i+1+12] & 0XF000) >> 12))
                    chn_data[16+5].append( ((onepkgdata[i+3+12] & 0X000F)<<8) +((onepkgdata[i+2+12] & 0XFF00) >> 8 ))
                    chn_data[16+4].append( ((onepkgdata[i+3+12] & 0XFFF0)>>4 ))

                    chn_data[16+3].append( 0x0000) 
                    chn_data[16+2].append( 0x0000)
                    chn_data[16+1].append( 0x0000)
                    chn_data[16+0].append( 0x0000)
   
                    chn_data[16+15].append( ( onepkgdata[i+3+1+12] & 0X0FFF)<<0 )
                    chn_data[16+14].append( ((onepkgdata[i+3+2+12] & 0X00FF)<<4) + ((onepkgdata[i+3+1+12] & 0XF000) >> 12))
                    chn_data[16+13].append( ((onepkgdata[i+3+3+12] & 0X000F)<<8) + ((onepkgdata[i+3+2+12] & 0XFF00) >> 8 ))
                    chn_data[16+12].append( ((onepkgdata[i+3+3+12] & 0XFFF0)>>4) )
    
                    chn_data[16+11].append( ((onepkgdata[i+6+1+12] & 0X0FFF)<<0 ))
                    chn_data[16+10].append( ((onepkgdata[i+6+2+12] & 0X00FF)<<4 )+ ((onepkgdata[i+6+1+12] & 0XF000) >> 12))
                    chn_data[16+9 ].append( ((onepkgdata[i+6+3+12] & 0X000F)<<8 )+ ((onepkgdata[i+6+2+12] & 0XFF00) >> 8 ))
                    chn_data[16+8 ].append( ((onepkgdata[i+6+3+12] & 0XFFF0)>>4 ))
