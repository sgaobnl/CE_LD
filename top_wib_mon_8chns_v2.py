...
Last modified: Wed Apr 24 13:04:54 2024
"""
...
import struct
import codecs
from cls_config_v2 import CLS_CONFIG
...
for wib_ip in LD.WIB_IPs:
    print (wib_ip)
    if "34.13" in wib_ip:
        LD.act_fembs[wib_ip] = [False, False, True, False] #1-3-2-126
    elif "34.14" in wib_ip:
        LD.act_fembs[wib_ip] = [False, True, False, True] #1-4-3-98, 1-4-1-24
    elif "34.15" in wib_ip:
        LD.act_fembs[wib_ip] = [False, False, True, True] #1-5-2-5, 1-5-3-47
    elif "34.16" in wib_ip:
        LD.act_fembs[wib_ip] = [False, True, False, False] #1-6-1-103
    elif "34.21" in wib_ip:
        LD.act_fembs[wib_ip] = [True, False, False, False] #2-1-0-49
    elif "34.23" in wib_ip:
        LD.act_fembs[wib_ip] = [True, False, False, False] #2-3-0-86
    else:
