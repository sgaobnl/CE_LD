            ...
            #for femb_addr in [0]:
                if self.act_fembs[wib_ip][femb_addr] == True:
                    ...
                    if monchn > 0 :
                        ...
                        if ("34.13" in wib_ip) and (femb_addr==2): 
                            tmpchn = 126
                        elif ("34.14" in wib_ip) and (femb_addr==3): 
                            tmpchn = 98
                        elif ("34.14" in wib_ip) and (femb_addr==1): 
                            tmpchn = 24
                        elif ("34.15" in wib_ip) and (femb_addr==2): 
                            tmpchn = 5
                        elif ("34.15" in wib_ip) and (femb_addr==3): 
                            tmpchn = 47
