...
def FEMB_CHK(fembdata, rms_f = False, fs="./"):
    ...
    for adata in fembdata:
        ...
        for achn in range(len(chn_data)):
            ...
            #    print (len(achn_ped), arms)
            #    plt.plot(chn_data[achn])
            #    plt.show()
            #    plt.close()
            #    if ("Y" in input()):
            #        exit()
    ...
    result = (True, "pass-", [chn_rmss, chn_peds, chn_pkps, chn_pkns, chn_rmss_filtered, chn_avg_waves])
...
def d_dec_plt(dec_chn, n=1):
    ...
    #n=CLEN-11-17+8 slkh
    #n=CLEN-11-17+13 slk
    #n=CLEN-11-17+14 sdacsw1
    #n=CLEN-11-17+15 sdacsw2 
    #n=CLEN-11-17+16 asicdac
    #n=CLEN-11-31+0 fpgadac_v
    #n=CLEN-11-31+2 pls_period
    #n=CLEN-11-31+4 fpga_tp_en
    #n=CLEN-11-31+5 asic_tp_en
    #n=CLEN-11-31+9 femb_tst_sel
    #n=CLEN-11-41+0 femb_clk_sel
    #n=CLEN-11-41+1 femb_cmd_sel
    #n=CLEN-11-41+4 tst_wfm_gen_mode
...
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FE TST (1:enable, 0:disable) distribution", fn = "SBND_APA_CFG_FE_TST_DIS.png", ns=[CLEN-11-17], ylim=[-2,2], ylabel="FE_TST", note="1:EN, 0:DIS, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FE SNC (Baseline) distribution", fn = "SBND_APA_CFG_FE_BL_DIS.png", ns=[CLEN-11-17+1], ylim=[-2,2], ylabel="FE_BL", note="1:200mV, 0:900mV, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FE SG0 (Gain0) distribution", fn = "SBND_APA_CFG_FE_SG0_DIS.png", ns=[CLEN-11-17+2], ylim=[-2,2], ylabel="FE_Gain0", note="1:7.8 or 25, 0:4.7 or 14, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FE SG1 (Gain1) distribution", fn = "SBND_APA_CFG_FE_SG1_DIS.png", ns=[CLEN-11-17+3], ylim=[-2,2], ylabel="FE_Gain1", note="1:14 or 25, 0:4.7 or 7.8, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FE ST0 (PeakTime0) distribution", fn = "SBND_APA_CFG_FE_ST0_DIS.png", ns=[CLEN-11-17+4], ylim=[-2,2], ylabel="FE_ST0", note="1:0.5 or 2, 0:1 or 3, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FE ST1 (PeakTime0) distribution", fn = "SBND_APA_CFG_FE_ST1_DIS.png", ns=[CLEN-11-17+5], ylim=[-2,2], ylabel="FE_ST1", note="1:2 or 3, 0:0.5 or 1, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FE SDF (Buf) distribution", fn = "SBND_APA_CFG_FE_SDF_DIS.png", ns=[CLEN-11-17+7], ylim=[-2,2], ylabel="FE_BUF", note="1:ON, 0:OFF, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FE SDACSW1 distribution", fn = "SBND_APA_CFG_FE_SDACSW1_DIS.png", ns=[CLEN-11-17+14], ylim=[-2,2], ylabel="FE_TST_Src", note="0:Ext_dis , 0: Ext_en, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FE SDACSW2 distribution", fn = "SBND_APA_CFG_FE_SDACSW1_DIS.png", ns=[CLEN-11-17+15], ylim=[-2,2], ylabel="FE_TST_Src", note="0:Int_dis , 0: Int_en, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FE SDAC distribution", fn = "SBND_APA_CFG_FE_SDAC_DIS.png", ns=[CLEN-11-17+16], ylim=[-2,78], ylabel="FE_DAC", note="0-3F: SDAC, -1:Bad")
    DIS_PLOT(dec_chn=result, fdir=rn, title = "FPGA-DAC distribution", fn = "SBND_APA_CFG_FPGA_DAC_DIS.png", ns=[CLEN-11-31+0], ylim=[-2,78], ylabel="FPGA_DAC", note="0-3F: FPGA-DAC, -1:Bad")
    DIS_PLOT(dec_chn=result, fdir=rn, title = "Pulse DLY distribution", fn = "SBND_APA_CFG_PLS_DLY_DIS.png", ns=[CLEN-11-31+1], ylim=[-0,50], ylabel="FPGA_Pls_Period", note=">0: Period, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "Pulse Period distribution", fn = "SBND_APA_CFG_PLS_Per_DIS.png", ns=[CLEN-11-31+2], ylim=[-2,2000], ylabel="FPGA_Pls_Period", note=">0: Period, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FPGA_TP_EN distribution", fn = "SBND_APA_CFG_FPGA_TP_EN_DIS.png", ns=[CLEN-11-31+4], ylim=[-2,2], ylabel="FPGA_TP_EN", note="1:en, 0:dis, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "ASIC_TP_EN distribution", fn = "SBND_APA_CFG_ASIC_TP_EN_DIS.png", ns=[CLEN-11-31+5], ylim=[-2,2], ylabel="ASIC_TP_EN", note="1:en, 0:dis, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "FEMB data mode distribution", fn = "SBND_APA_CFG_FEMB_Data_Mode_DIS.png", ns=[CLEN-11-31+9], ylim=[-2,6], ylabel="FEMB_Data_Mode", note="0:ADC, 1:TestPattern,2:Waveform, 3:CHN_Map, 4:Sawtooth, -1:Bad")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "WIB CLK distribution", fn = "SBND_APA_CFG_WIB_CLK_DIS.png", ns=[CLEN-11-41+0], ylim=[-2,2], ylabel="WIB CLK SRC", note="0:OSC100MHz, 1:SI5344")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "WIB CMD distribution", fn = "SBND_APA_CFG_WIB_CMD_DIS.png", ns=[CLEN-11-41+1], ylim=[-2,2], ylabel="WIB CMD SRC", note="0:WIB, 1:MBB")
#    DIS_PLOT(dec_chn=result, fdir=rn, title = "WIB TST WFM distribution", fn = "SBND_APA_CFG_WIB_TST_WFM_DIS.png", ns=[CLEN-11-41+4], ylim=[-2,4], ylabel="WIB TST WFM Mode", note="0:from FEMB, 1:Sawtooth,2:CHN-Map, -1:Bad")


rawdir = """/Users/shanshangao/Downloads/SBND_LD/dly_run/"""
