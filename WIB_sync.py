...
Last modified: 1/19/2024 10:22:18 AM
"""
...
#    datamode = int(input ("1, 2 (exit fake data mode with anyother values): "))
#
#    if datamode == 1:
...
#        exit()
#    time.sleep(0.1)
#    wib.write_reg_wib_checked(4, 0x8)
#    wib.write_reg_wib_checked(8, 0x0)
#    time.sleep(0.1)
    while True:
        synflg = str(input("Want to perform Nevis SYNC (Y/N)? : "))
