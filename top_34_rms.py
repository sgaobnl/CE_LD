...
for crateno in cratenos:
    ...
    while (PTBslotno < 7) and (PTBslotno > 0):
        a = FEMB_QC()
        a.userdir = "/home/nfs/sgao/SBND_Installation/data/1129/RMS/"  
        a.userdir = "/scratch_local/SBND_Installation/data/sgao_02022024/RMS3/"
        a.userdir = "/scratch_local/SBND_Installation/data/sgao_03042024/RMS2/"
        a.userdir = "/scratch_local/SBND_Installation/data/sgao_03142024/RMS/"
