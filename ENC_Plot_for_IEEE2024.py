...
def DIS_PLOT(dec_chn, fdir, title = "RMS Noise Distribution", fn = "SBND_APA_RMS_DIS.png", ns=[5],  ylim=[-2,10], ylabel = "ENC /e$^-$", note = ""):
    import matplotlib.pyplot as plt
    ...
    ax2.text(1000, 200, "U", color='b', fontsize=16)
    ax2.text(3000, 200, "V", color='g', fontsize=16)
    ax2.text(5000, 200, "Y", color='r', fontsize=16)
...
def DIS_PLOTs(result, rn):
    DIS_PLOT(dec_chn=result, fdir=rn, title = "ENC Noise Distribution", fn = "SBND_APA_ENC_DIS.png", ns=[5], ylim=[0,800])
